---
title: "Getting Started with Activiti Core 7.0.0.Beta1"
date: 2018-08-13 08:01:21 +0000
permalink: /2018/08/13/getting-started-with-activiti-core-7-0-0-beta1/
description: "We have just released Activiti Core and Activiti Cloud 7.0.0.Beta1 to Maven Central and we wanted to highlight the new Process and Task Runtime APIs."
tags:
  - "activiti7"
  - "bpmn2"
  - "cloud"
  ...
  - "docker"
  - "process"
original_url: https://www.salaboy.com/2018/08/13/getting-started-with-activiti-core-7-0-0-beta1/
---

We have just released ***Activiti Core and Activiti Cloud 7.0.0.Beta1*** to [Maven Central](https://search.maven.org/search?q=g:org.activiti.cloud) and we wanted to highlight the new ***Process and Task Runtime APIs***.
...
The ***Task*Runtime** APIs are here to help you.
...
Now let’s switch to our DemoApplication.class: <https://github.com/Activiti/activiti-examples/blob/master/activiti-api-basic-task-example/src/main/java/org/activiti/examples/DemoApplication.java#L25>
...
Process Definitions needs to be placed inside the [/src/main/resources/processes/](https://github.com/Activiti/activiti-examples/tree/develop/activiti-api-basic-process-example/src/main/resources/processes) . For this example we have the following process defined:

![process-with-service-task](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2018/08/process-with-service-task.png)
...
Check the maven module [**activiti-api-spring-integration-example**](https://github.com/Activiti/activiti-examples/tree/develop/activiti-api-spring-integration-example) for a more advanced example using Spring Integrations to kickstart processes based on a File poller.

## Full Example

You can find an example using both, the ***ProcessRuntime*** and ***TaskRuntime*** APIs to automate the following process:

![process-with-user-task](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2018/08/process-with-user-task.png)
