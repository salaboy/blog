---
title: "JHipster MicroService Application in Kubernetes KIND"
date: 2019-06-27 05:38:12 +0000
permalink: /2019/06/27/jhipster-microservice-application-in-kubernetes-kind/
description: "On this blog post I will be going through all the process from creating a MicroServices application with JHipster to run the application into a KIND…"
tags:
  - "basic"
  - "cloud"
  - "community"
  ...
  - "docker"
  - "microservices"
original_url: https://www.salaboy.com/2019/06/27/jhipster-microservice-application-in-kubernetes-kind/
---
...
![Kind](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2019/06/kind.png)![Jhipster logo](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2019/06/jhipster-logo-1.png)

### Prerequisites

- [JHipster CLI (Java, Maven)](https://www.jhipster.tech/installation/)
- [Docker](https://docs.docker.com/docker-for-mac/install/)    - You need to make sure that you allow Docker enough CPUs and memory to run the Applications (Docker -> Preferences -> Advanced). I've set up 4 CPUs and 8 GB RAM.
...
In order to create the source code for this application we need to import our JDL file by calling (you can find the ****app.jdl**** file inside the [example-app/](https://github.com/salaboy/jhipster-operator/blob/master/example-app/) directory):
...
![Jhipster flow](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2019/06/jhipster-flow.png)
...
![Screenshot 2019 06 26 at 15.20.](https://cdn.jsdelivr.net/gh/salaboy/blog-assets@v1/images/2019/06/screenshot-2019-06-26-at-15.20.56.png)
...
Future work might include use KIND for integration testing of our JHipster Applications. If you have questions feel free to drop me a message here on in Twitter: [@salaboy](http://twitter.com/salaboy).
